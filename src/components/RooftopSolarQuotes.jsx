...
const cardData = [
    ...
    {
        hName: '',
        primary1: (<Link href='#' style={{ color: 'green', display: 'flex', alignItems: 'center', justifyContent: 'flex-start', lineHeight: '1.3', fontSize: '16px', fontWeight: 'normal' }}>View Profile &nbsp;<ArrowCircleRightIcon fontSize='16px' /></Link>),
        primary2: (<Link href='#' style={{ color: 'green', display: 'flex', alignItems: 'center', justifyContent: 'flex-start', lineHeight: '1.3', fontSize: '16px', fontWeight: 'normal' }}>View Profile &nbsp;<ArrowCircleRightIcon fontSize='16px' /></Link>),
    }
]
